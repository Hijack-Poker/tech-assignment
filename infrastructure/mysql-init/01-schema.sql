...
CREATE TABLE games (
  ...
  last_raise_size DECIMAL(10,2) DEFAULT 0.00 COMMENT 'Size of the last raise for min-raise calc',
...
CREATE TABLE game_players (
  ...
  best_hand JSON COMMENT '["AH","AD","AS","KH","KD"] - best 5-card hand at showdown',
  hand_rank VARCHAR(50) DEFAULT '' COMMENT 'Best hand description',
  is_winner TINYINT(1) DEFAULT 0 COMMENT '1 if this player won the hand',
